function cpar = line_to_dict(line)
    ...
    % Parse liquid EOS parameters
    liquid_eos_params = strsplit(string(line.liquid_eos_params), ';');
    liquid_eos_params = cellfun(@str2double, liquid_eos_params(~cellfun('isempty', liquid_eos_params))); % Convert to numeric
    ...
    cpar = struct(...
        ...
        'enable_van_der_waals', line.enable_van_der_waals == "true", ...
        'enable_rate_thresholding', line.enable_rate_thresholding == "true", ...
        'target_specie', string(line.target_specie), ...
        'excitation_type', string(line.excitation_type), ...
        'excitation_params', excitation_params, ...
        'excitation_cycles', double(line.excitation_cycles), ...
        'ramp_up_cycles', double(line.ramp_up_cycles) ...
    );
end