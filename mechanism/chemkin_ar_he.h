...
enum index                             {       H =  0,     H2 =  1,      O =  2,     O2 =  3,     OH =  4,    H2O =  5,     N2 =  6,    HO2 =  7,   H2O2 =  8,     AR =  9,     HE = 10,   OHEX = 11,     INVALID = 12 };
// molar mass [g/mol]
...
constexpr std::array<std::array<size_t, 4>, 30> nu_indexes = {{
    {   0,   2,   3,   4},    //  0. H+O2=O+OH
    {   0,   1,   2,   4},    //  1. O+H2=H+OH
    {   0,   1,   4,   5},    //  2. OH+H2=H+H2O
    {   2,   4,   5,  12},    //  3. 2OH=O+H2O
    {   0,   1,  12,  12},    //  4. 2H+M=H2+M
    {   2,   3,  12,  12},    //  5. 2O+M=O2+M
    {   0,   2,   4,  12},    //  6. O+H+M=OH+M
    {   0,   4,   5,  12},    //  7. H+OH+M=H2O+M
    {   0,   3,   7,  12},    //  8. H+O2(+M)=HO2(+M)
    {   0,   1,   3,   7},    //  9. H+HO2=H2+O2
    {   0,   4,   7,  12},    // 10. HO2+H=2OH
    {   2,   3,   4,   7},    // 11. HO2+O=OH+O2
    {   3,   4,   5,   7},    // 12. HO2+OH=H2O+O2
    {   3,   7,   8,  12},    // 13. 2HO2=H2O2+O2
    {   3,   7,   8,  12},    // 14. 2HO2=H2O2+O2
    {   4,   8,  12,  12},    // 15. 2OH(+M)=H2O2(+M)
    ...
    {   0,   2,  11,  12},    // 21. H+O+M=OHEX+M
    {   4,   5,  11,  12},    // 22. OHEX+H2O=OH+H2O
    {   1,   4,  11,  12},    // 23. OHEX+H2=OH+H2
    {   4,   6,  11,  12},    // 24. OHEX+N2=OH+N2
    {   4,  11,  12,  12},    // 25. OHEX+OH=2OH
    {   0,   4,  11,  12},    // 26. OHEX+H=OH+H
    {   4,   9,  11,  12},    // 27. OHEX+AR=OH+AR
    {   4,  11,  12,  12},    // 28. OHEX=OH+HV
    {   3,   4,  11,  12}     // 29. OHEX+O2=OH+O2
}};

constexpr std::array<std::array<std::array<char, 4>, 3>, 30> nu = {{
...
constexpr std::array<bool, 7> is_pressure_dependent = {{ false, false, false, false,  true,  true, false}};
...
constexpr std::array<size_t, 2> is_third_body_indexes = {{   4,   5}};
